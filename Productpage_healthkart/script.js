...
var b = new productObj(
  32,
  "https://img6.hkrtcdn.com/14889/prd_1488805-MB-Fuel-One-Whey-Protein-Immunity-8.8-lb-Chocolate_c_m.jpg",
...
function displayData() {
  ...
  array.map(function (elem) {
    ...
    vegimg.id = "vegimg";
    vegimg.src =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ1yUU0RvY44r9bS4_A8McYfu6Igno-loyWA&usqp=CAU";
    ...
    upperbox.append(redbox,heartimg);
    let off = document.createElement("p");
    off.id = "off";
    off.innerText = `${elem.discount}% off`;
    redbox.append(off);
    ...
    ratingQ = document.createElement("p");
    ratingQ.innerText = `(${elem.ratingQ})`;
    ratingQ.id = "ratingQ";
    starrating = document.createElement("img");
    starrating.id = "starrating"
    starrating.src = "./rating.png"
    ratingdiv.append(starrating,rating,ratingQ)
    let pricediv = document.createElement("div");
    pricediv.id = "pricediv";
    let price = document.createElement("h2");
    price.id = "price";
    price.innerText = `₹${elem.price}`;
    let strPrice = document.createElement("s");
